 ...
 * Manages secure HTTP-only cookies for Render OAuth state and connection data
 */
...
const STATE_COOKIE_NAME = 'render_oauth_state';
const CONNECTION_COOKIE_NAME = 'render_connection';

export class RenderCookieManager {
  /**
  ...
  /**
   * Check if user is connected to Render
   */
