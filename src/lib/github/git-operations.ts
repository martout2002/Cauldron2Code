...
export class GitOperationsService {
  ...
  static generateCommitMessage(config: ScaffoldConfig): string {
    ...
    const title = `🚀 Initial commit - Generated by Cauldron2Code`;
    ...
    const footer = `\n\n---\n\nThis project was scaffolded using [Cauldron2Code](https://cauldron2code.dev), an AI-powered full-stack generator.\n\nColor scheme: ${config.colorScheme}\nProject: ${config.projectName}`;
  ...
  async createInitialCommit(
    files: GeneratedFile[],
    author: GitAuthor,
    commitMessage: string = 'Initial commit from Cauldron2Code'
  ): Promise<string> {
    try {
